...
#define CONFIG_ESP_LCD_TOUCH_MAX_BUTTONS 1    // Points that are allowed to be touched  
#define CONFIG_ESP_LCD_TOUCH_MAX_POINTS  5    // Maximum number of touch points
